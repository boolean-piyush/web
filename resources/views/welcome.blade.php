...
<div class="row">
    ...
    <div class="col-md-6 col-12 rounded" >
            <ul class="list-group">
                ...
                <a v-for="job in recents" :class="{'list-group-item':true, 'homepage-exams':true, 'strip-color-dark': (recents.indexOf(job)%2 == 0)}" :href="job[1]">@{{job[0]}}
    ...
    <div class="col-md-6 col-12 rounded">
            <ul class="list-group">
                ...
                <a v-for="job in most_viewed" :class="{'list-group-item':true, 'homepage-exams':true, 'strip-color-dark': (most_viewed.indexOf(job)%2 == 0)}" :href="job[1]">@{{job[0]}}
                    <span v-if="job[2]" class="badge badge-pill badge-danger">New</span><br>
                </a>
