...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vuejs_datepicker__ = __webpack_require__(65);
Vue.component('dynamic-table', __webpack_require__(59));
Vue.component('two-col-table', __webpack_require__(62));
...
var app3 = new Vue({
    ...
    methods: {
        ...
        calculate_cagr: function calculate_cagr() {
        ...
        final_cagr: function final_cagr() {
            var time = Number(this.time);
