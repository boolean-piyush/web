...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return faFlag; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return faMinusCircle; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__fortawesome_vue_fontawesome__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vuejs_datepicker__ = __webpack_require__(23);
Vue.component('dynamic-table', __webpack_require__(60));
Vue.component('two-col-table', __webpack_require__(63));




__WEBPACK_IMPORTED_MODULE_0__fortawesome_fontawesome_svg_core__["c" /* library */].add(__WEBPACK_IMPORTED_MODULE_1__fortawesome_free_solid_svg_icons__["c" /* faMinusCircle */]);
Vue.component('font-awesome-icon', __WEBPACK_IMPORTED_MODULE_2__fortawesome_vue_fontawesome__["a" /* FontAwesomeIcon */]);


Vue.component('date-picker', __WEBPACK_IMPORTED_MODULE_3_vuejs_datepicker__["a" /* default */]);
...
var app3 = new Vue({
    ...
    data: {
        ...
        status: ["Online-Form", "Admit-Card", "Form-Correction", "Result"]
    },

    created: function created() {
        $.get('/get-depts', function (data) {
            console.log(data);
            for (var key in data) {
    ...
    methods: {
        fetchdata: function fetchdata() {
            ...
            $.get('/filter-data?dept[]=' + this.dept_values + '&qualification=' + this.qualification_value, function (data) {
                this.rawhtml = data;
            }.bind(this));
        },

        on_ready_to_submit: function on_ready_to_submit() {
        ...
        scan: function scan() {
            ...
            $.get('/sarkari', function (data, status) {
        ...
        handle_depts: function handle_depts() {
            console.log("hello");
        }
    },
    computed: {
        validate_user_email: function validate_user_email() {
            var re = /^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;
            var email_correct = re.test(this.user_email);

            if (email_correct) this.user_not_genuine = false;else this.user_not_genuine = true;

            return email_correct;
        },
        validate_user_mobile: function validate_user_mobile() {
            var re = /^([6-9]{1})([0-9]{9})$/;
            var mobile_correct = re.test(this.user_mobile);

            if (mobile_correct) this.user_not_genuine = false;else this.user_not_genuine = true;
...
Component.options.__file = "resources/assets/js/components/dynamic-table.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-34aa478e", Component.options)
  } else {
    hotAPI.reload("data-v-34aa478e", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
   ...
   methods: {
      update_table: function update_table(col, row) {
   ...
   computed: {
      get_table_properties: function get_table_properties() {
...
var render = function() {
  ...
  return _c("div", { attrs: { id: "workspace" } }, [
    _c("div", { staticClass: "row" }, [
      _c("p", { staticClass: "col-6" }, [
        _vm._v("Please enter number of rows and columns respectivily -->")
      ]),
      _vm._v(" "),
      _c("input", {
        directives: [
          {
            name: "model",
            rawName: "v-model",
            value: _vm.temp_n_rows,
            expression: "temp_n_rows"
          }
        ],
        staticClass: "col-2",
        attrs: { type: "text" },
        domProps: { value: _vm.temp_n_rows },
        on: {
          input: function($event) {
            if ($event.target.composing) {
              return
            }
            _vm.temp_n_rows = $event.target.value
          }
        }
      }),
      _vm._v(" "),
        ...
        directives: [
          {
            name: "model",
            rawName: "v-model",
            value: _vm.temp_n_cols,
            expression: "temp_n_cols"
          }
        ],
        staticClass: "col-2",
        attrs: { type: "text" },
        domProps: { value: _vm.temp_n_cols },
        on: {
          input: function($event) {
            if ($event.target.composing) {
              return
            }
            _vm.temp_n_cols = $event.target.value
          }
        }
      }),
      _vm._v(" "),
      _c(
        "button",
        {
          staticClass: "col-2 btn btn-success btn-sm",
          attrs: { type: "button" },
          on: {
            click: function($event) {
              _vm.update_table(_vm.temp_n_cols, _vm.temp_n_rows)
            }
          }
        },
        [_vm._v("Build Table")]
    ...
    _vm._v(" "),
    _c("h5", [_c("b", [_vm._v("Total rows- " + _vm._s(_vm.n_rows))])]),
    _vm._v(" "),
    _vm.n_rows > 0
      ? _c("label", [
          _c("input", {
            ...
            on: {
              click: function($event) {
                _vm.first_row_bold = true
              }
            }
          }),
          _vm._v("First Row Bold")
        ])
      : _vm._e(),
    _vm._v(" "),
    _c(
      "table",
      { staticClass: "table table-sm table-bordered table-secondary" },
      [
        _c(
          "tbody",
          [
            _vm.n_rows > 0
              ? _c(
                  ...
                  [
                    _c("th"),
                    _vm._v(" "),
                    _vm._l(_vm.n_cols, function(col) {
                            ...
                            directives: [
                              {
                                name: "model",
                                rawName: "v-model",
                                value: _vm.column_bold,
                                expression: "column_bold"
                              }
                            ],
                            attrs: { type: "checkbox" },
                            domProps: {
                              value: col,
                              checked: Array.isArray(_vm.column_bold)
                                ? _vm._i(_vm.column_bold, col) > -1
                                : _vm.column_bold
                            },
                            on: {
                              change: function($event) {
                                var $$a = _vm.column_bold,
                                  $$el = $event.target,
              ...
              : _vm._e(),
            _vm._v(" "),
            _vm._l(_vm.n_rows, function(row) {
              return _c(
                "tr",
                { key: row },
                [
                    ...
                    return _c("th", { key: col }, [
                      _c("textarea", {
                        attrs: {
                          ...
                          type: "text",
                          name:
                            _vm.section + "-cell-" + row + "-" + String(col),
                          cols: parseInt(160 / _vm.n_cols),
                          rows: "4"
                        }
                      })
                    ])
    ...
    _vm._v(" "),
    _c("input", {
      attrs: { type: "hidden", name: _vm.section + "_table_properties" },
      domProps: { value: _vm.get_table_properties }
    })
  ])
}
var staticRenderFns = []
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-34aa478e", module.exports)
  }
}
...
Component.options.__file = "resources/assets/js/components/two-col-table.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-81ed430e", Component.options)
  } else {
    hotAPI.reload("data-v-81ed430e", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vuejs_datepicker__ = __webpack_require__(23);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
   ...
   data: function data() {
      return {
         ...
         sections: {
            ...
            date: ["Exam form filling start date:-", "Last Date Apply Online:-", "Last Date Fees Payment:-", "Admit Card Available:-", "Exam Date:-", "Result Date:-"],

            links: ["Form Correction", "Pay Exam Fees", "Verify Fees Payment", "Candidate Login", "How to Apply (Step by Step)", "Instructions [English]", "Instructions [Hindi]", "Official Website", "Syllabus"]
   ...
   methods: {
      get_name: function get_name(row, col) {
         return this.section + "-cell-" + (row + 1) + "-" + col;
      },
      on_row_add: function on_row_add() {
...
var render = function() {
  ...
  var _c = _vm._self._c || _h
  return _c("div", [
    _c("h5", [_vm._v("Rows-> " + _vm._s(this.sections[this.section].length))]),
    _vm._v(" "),
    _c("table", { staticClass: "table table-sm table-striped" }, [
      _c(
        "tbody",
        _vm._l(_vm.sections[_vm.section], function(value) {
            ...
            _c("th", [
              _c(
                "button",
                {
                  ...
                  on: {
                    click: function($event) {
                      _vm.sections[_vm.section].splice(
                        _vm.sections[_vm.section].indexOf(value),
                        1
                      )
                    }
                  }
        ...
        directives: [
          {
            name: "model",
            rawName: "v-model",
            value: _vm.new_row_value,
            expression: "new_row_value"
          }
        ],
        staticClass: "form-control col-3 border border-success",
        attrs: { autocomplete: "off", type: "text" },
        domProps: { value: _vm.new_row_value },
        on: {
          input: function($event) {
            if ($event.target.composing) {
              return
            }
            _vm.new_row_value = $event.target.value
          }
        }
      }),
      _vm._v(" "),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-81ed430e", module.exports)
  }
}
